...
<body>
    ...
    <header class="header">
        ...
        <div class="icons">
            ...
            <div class="fa fa-shopping-cart" title="go to your cart" id="cart-btn"></div>
            ...
            margin-right: .4rem;
            text-align: center;
            border: none;" href="../login-register/logout.php" class="fa fa-sign-out" title="logout button" id="login-btn"></a>
